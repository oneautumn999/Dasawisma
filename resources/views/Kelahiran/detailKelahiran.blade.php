        ...
        <div class="col-lg-6 col-md-12">
            <div class="card h-100">
                <div class="card-header pb-0">
                    <h6>Detail Data {{$data->jumlah_kk}}</h6>
                    <p class="text-sm">
                    ...
                    <div class="timeline timeline-one-side">
                        ...
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">{{$data->jumlah_buta}}</p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">{{$data->jumlah_ibuhamil}}</p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">{{$data->jumlah_kebutuhanusus}}</p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                                <i class="ni ni-world text-dark text-gradient"></i>
                            </span>
                            <!-- <div class="timeline-content">
                        ...
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                                <i class="ni ni-building text-dark text-gradient"></i>
                            </span>
                            <!-- <div class="timeline-content">
                        ...
                        <div class="timeline-block">
                            <span class="timeline-step">
                                <i class="ni ni-bell-55 text-dark text-gradient"></i>
                            </span>
                            <!-- <div class="timeline-content">
