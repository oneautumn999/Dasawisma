...
<div class="card z-index-0">
    <div class="card-header text-center pt-4">
      <h5>Tambah Data Anggota Warga </h5>
    </div>
    <div class="card-body">
      <form role="form text-left" action="{{route('simpanAnggotaWarga')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
        ...
        <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_anggota" placeholder="Nama Anggota Keluarga" aria-label="Password" aria-describedby="password-addon" required>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="col-12 col-md-12">
            ...
            <div class="mb-3">
                <label>Jenis Ikut </label>
                    <select required name="jenis_ikut" class="form-control">
                    <option value="">--Select--</option>
                    <option value="Pengajian">Pengajian </option>
                    <option value="Arisan">Arisan</option>
                    <option value="Gosip">Gosip</option>
                    <option value="Ngerumpi">Ngerumpi</option>
                </select>     
            </div>
        </div>
